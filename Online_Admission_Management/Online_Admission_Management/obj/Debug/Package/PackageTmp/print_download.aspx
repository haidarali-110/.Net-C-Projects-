...
<body>
    ...
    <div class="admission-form">
        <img class="college-logo" src="Ad_image/Logo.jpg" alt="College Logo">
   ...
   <script type="text/javascript">
       ...
       function downloadAdmissionForm() {
           ...
           var imgData = 'Ad_image/Logo.jpg';  // Replace this with the correct path to your image
           pdf.addImage(imgData, 'JPEG', 10, 10, 50, 50);  // Adjust the coordinates and size as needed

           // Add content from the admission form
           var admissionFormContent = document.querySelector('.admission-form').outerHTML;
           pdf.fromHTML(admissionFormContent, 10, 70);
