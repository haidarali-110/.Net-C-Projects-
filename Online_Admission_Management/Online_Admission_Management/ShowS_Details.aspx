...
<body>
    ...
    <div class="lable_Ragister">    
        ...
        <asp:GridView ID="GridView1" runat="server" BackColor="White" 
            ...
            GridLines="Horizontal" AutoGenerateColumns="False" DataKeyNames="id"  OnRowEditing="GridView1_RowEditing"
...
<asp:Button ID="ButtonSearch2" runat="server" Text="Search" 
        ...
        <div  class="lable_Admission">
            ...
            <asp:GridView ID="GridView2" runat="server" BackColor="White" BorderColor="#336666" 
                    ...
                    GridLines="Horizontal" AutoGenerateColumns="False" DataKeyNames="id"  OnRowEditing="GridView2_RowEditing"
    ...
    OnRowDeleting="GridView2_RowDeleting">
        ...
        <asp:BoundField DataField="moNo" HeaderText="Mobile Number" SortExpression="moNo" />
        <asp:BoundField DataField="Email" HeaderText="Email" SortExpression="Email" />
        <asp:BoundField DataField="birthdate" HeaderText="Birthdate" SortExpression="birthdate" />
        <asp:BoundField DataField="gender" HeaderText="Gender" SortExpression="gender" />
        <asp:BoundField DataField="category" HeaderText="Category" SortExpression="category" />
        <asp:BoundField DataField="course" HeaderText="Course" SortExpression="course" />
        <asp:BoundField DataField="passingMY" HeaderText="Passing Month & Year" SortExpression="passingMY" />
        <asp:BoundField DataField="seatno" HeaderText="Seat No." SortExpression="seatno" />
        <asp:BoundField DataField="outofmarks" HeaderText="Obtain Mark/Out of Marks" SortExpression="outofmarks" />
